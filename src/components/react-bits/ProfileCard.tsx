...
import "/src/assets/css/profile-card.css";
...
const round = (v: number, precision: number = 3): number =>
...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
  ...
  useEffect(() => {
    ...
    const pointerEnterHandler = (e: PointerEvent) =>
      handlePointerEnter(e as unknown as React.PointerEvent<HTMLDivElement>);
    const pointerLeaveHandler = () => handlePointerLeave();
    const deviceOrientationHandler = (e: Event) =>
      handleDeviceOrientation(e as DeviceOrientationEvent);
